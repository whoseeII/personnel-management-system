<div class="row">
    <div class="col-12">
        <div class="card card-info  h-100">
            ...
            <form class="form-horizontal" action="/personnel-management-system/controller/employee/update.php?id=<?= $_GET['id'] ?>" method="post" enctype="multipart/form-data">
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 text-center" id="img-prev">
                        <div class="form-group col-12 img-prev">
                            <label class="col-sm-4 control-label">* Employee Photo</label><br>
                        </div>
                        
                    </div>
                    <div class="col-md-12 d-none" id="photo-div">
            ...
            <div class="card-footer text-center">
                ...
                <button type="button" class="btn btn-default btn-cancel">
                    <a href="?page=employee_view&id=<?= $_GET['id'] ?>"> Cancel</a>
                </button>
            </div>
            </form>
        </div>
